      ...
      >
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class=" transform overflow-hidden rounded-lg justify-center flex-row flex bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-max sm:min-w-min">
